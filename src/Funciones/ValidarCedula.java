...
/**
 * <p>
 * Validador de Número de Cédula Nicaraguense</p>
 * <p>
 * Este programa es software libre: usted lo puede redistribuir y/o modificar
...
public class ValidarCedula {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            cedula.setCedula(JOptionPane.showInputDialog("¿Cédula a validar?"));
            gui = true;
        } else {
            cedula.setCedula(args[0]);
        }
